...
- [ ] It should be more efficient to just calculate an inverse matrix for each of the transformation of the objects instead of calculating it each time (thanks to [Aritz](https://github.com/aolabarr))
